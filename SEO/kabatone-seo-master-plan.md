...
| CTR-001 | Track C: freshness signal fix (`articleSchema` `dateModified` bug) + real refresh on `what-is-video-management-software` + `what-is-video-analytics` | High | Done | v2.279 — 2026-07-27 — see `SEO/ctr-diagnosis-2026-07-20.md` for the diagnosis and `SEO/ctr-recovery-plan-2026-07-27.md` for the full CTR-recovery plan. Internal-link expansion (originally proposed for these pages) was found already saturated (55/24 inbound links) and skipped. |
