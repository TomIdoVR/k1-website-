...
| GEO-049 | RTCC citability refresh — "leading RTCC software vendors" flagged Y→N volatile 3 cycles running | High | Not started | The existing /resources/rtcc-software/ page already names KabatOne alongside Axon/Fusus, Genetec, Hexagon, Mark43, Milestone, Motorola, Verkada, but citation keeps dropping between monitor runs. Needs a fresh pass adding more specific, self-contained numbers/facts (not a new page) — next candidate for the "citability refresh" pattern rather than a new roundup. |
