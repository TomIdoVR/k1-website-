...
| SHIP-1 | Promote `nextjs` → `main` | 2026-08-21 | Omer | blocked | **The one item genuinely waiting on Omer today.** Production last updated 2026-08-21; 13+ commits behind. Verified live: production still serves `/resources/ai-video-analytics` 200 while staging 302s it to the consolidation target — v2.329's redirects and v2.331's canonical fixes are worth zero until promoted, and any Track C measurement is measuring stale pages. |
