...
export default async function ResourcesPage({
  ...
  const articles = es
    ? [
        ...
        {
          href: '/resources/milestone-alternatives',
          category: 'Guía de Compra',
          title: 'Mejores Alternativas a Milestone XProtect',
          excerpt: 'Las mejores alternativas a Milestone XProtect para seguridad pública — KabatOne, Genetec, Avigilon, Verkada, Axon/Fusus y Motorola comparadas — y cuándo una plataforma unificada supera a un VMS puro.',
          readTime: '8 min',
          isNew: true,
        },
        {
          href: '/resources/best-ai-video-analytics-software',
          category: 'Guía de Compra',
          title: 'Mejor Software de Analítica de Video con IA',
          excerpt: 'El mejor software de analítica de video con IA para seguridad pública — KabatOne, BriefCam, Avigilon, Genetec, Verkada y Axon/Fusus comparados — precisión, falsos positivos y cuándo la analítica debe convertirse en despacho.',
          readTime: '8 min',
          isNew: true,
        },
        {
          href: '/resources/best-ng911-software',
          category: 'Guía de Compra',
          title: 'Mejor Software NG911',
          excerpt: 'El mejor software NG911 para centros de llamadas de emergencia — KabatOne, Carbyne, Motorola VESTA, Intrado/Comtech, RapidSOS y Prepared 911 comparados — i3/ESInet, recepción multimedia y cuándo la llamada debe convertirse en despacho.',
          readTime: '8 min',
          isNew: true,
        },
        {
    ...
    : [
        ...
        },
        {
          href: '/resources/milestone-alternatives',
          category: 'Buyer\'s Guide',
          title: 'Best Milestone XProtect Alternatives',
          excerpt: 'The best Milestone XProtect alternatives for public safety — KabatOne, Genetec, Avigilon, Verkada, Axon/Fusus and Motorola compared — and when a unified platform beats a pure VMS.',
          readTime: '8 min',
          isNew: true,
        },
        {
          href: '/resources/best-ai-video-analytics-software',
          category: 'Buyer\'s Guide',
          title: 'Best AI Video Analytics Software',
          excerpt: 'The best AI video analytics software for public safety — KabatOne, BriefCam, Avigilon, Genetec, Verkada and Axon/Fusus compared — accuracy, false positives, and when analytics must become dispatch.',
          readTime: '8 min',
          isNew: true,
        },
        {
          href: '/resources/best-ng911-software',
          category: 'Buyer\'s Guide',
          title: 'Best NG911 Software',
          excerpt: 'The best NG911 software for emergency call centers — KabatOne, Carbyne, Motorola VESTA, Intrado/Comtech, RapidSOS and Prepared 911 compared — i3/ESInet, multimedia intake, and when the call must become dispatch.',
          readTime: '8 min',
          isNew: true,
        },
        {
        ...
        {
          href: '/resources/public-safety-software-venezuela',
          category: 'Guide',
          title: 'Public Safety Software for Venezuela',
          excerpt: 'Public safety technology for Venezuelan institutions — PNB ~100K officers, CICPC/GNB/FANB interagency coordination, PDVSA Lake Maracaibo infrastructure protection, and Puerto Cabello port security.',
          readTime: '6 min',
          isNew: true,
        },
        {
          href: '/resources/public-safety-software-bolivia',
          category: 'Guide',
          title: 'Public Safety Software for Bolivia',
          excerpt: 'Public safety technology for Bolivia 9 departments — Policia Boliviana ~40K officers, FELCN drug control in Chapare/Yungas, YLB lithium security at Salar de Uyuni, and NB-SABS/SICOES procurement.',
          readTime: '6 min',
          isNew: true,
        },
        {
          href: '/resources/public-safety-software-uruguay',
          category: 'Guide',
          title: 'Public Safety Software for Uruguay',
          excerpt: 'Public safety technology for Uruguay 19 departments — Policia Nacional ~17K officers, unified 911 system, smart city Montevideo, Port of Montevideo, Carrasco Airport, and AGESIC/TOCAF procurement.',
          readTime: '6 min',
          isNew: true,
        },
        {
