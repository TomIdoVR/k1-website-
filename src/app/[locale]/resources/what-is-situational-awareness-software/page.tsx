      ...
      <div style={{ paddingTop: '70px', background: 'var(--bg)', color: 'var(--white)', minHeight: '100vh' }}>
        ...
        <section style={sectionStyle}>
          <div style={containerStyle}>
            ...
            <p style={pStyle}>
              {es
                ? <>La conciencia situacional efectiva requiere video, no solo datos de texto y coordenadas. Cuando un analista selecciona un incidente en el mapa, la plataforma muestra automáticamente las cámaras más cercanas al punto del evento. El analista no necesita buscar manualmente entre cientos o miles de cámaras — el sistema presenta las que son relevantes para la situación actual. En plataformas avanzadas, el video incluye <Link href="/resources/cctv-video-analytics" style={{ color: ACCENT, textDecoration: 'none', borderBottom: `1px solid ${ACCENT}40` }}>analítica de video con IA</Link> superpuesta: detección de comportamiento, conteo de personas y reconocimiento de placas en tiempo real.</>
                : <>Effective situational awareness requires video, not just text data and coordinates. When an analyst selects an incident on the map, the platform automatically displays the cameras closest to the event point. The analyst does not need to manually search through hundreds or thousands of cameras — the system surfaces the ones relevant to the current situation. In advanced platforms, the video includes overlaid <Link href="/resources/cctv-video-analytics" style={{ color: ACCENT, textDecoration: 'none', borderBottom: `1px solid ${ACCENT}40` }}>AI video analytics</Link>: behavior detection, people counting, and real-time license plate recognition.</>}
            </p>
