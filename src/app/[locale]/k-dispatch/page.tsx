          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px' }}>
              {(es ? [
                ...
                { title: 'Centro de Comando C4/C5', desc: 'Los centros de Comando, Control, Cómputo, Comunicaciones y Contacto Ciudadano requieren integración profunda con video, GIS, radio y analítica. K-Dispatch es el módulo de despacho dentro de la plataforma K-Safety, conectando todos los subsistemas del C5.' },
                ...
                { title: 'C4/C5 Command Center', desc: 'Command, Control, Computing, Communications, and Citizen Contact centers require deep integration with video, GIS, radio, and analytics. K-Dispatch is the dispatch module within the K-Safety platform, connecting all C5 subsystems.' },
