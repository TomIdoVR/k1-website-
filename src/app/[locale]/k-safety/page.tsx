...
/* The production K-Safety page, rendering the redesigned solution layout.
   ...
   ('kSafety'), so titles, descriptions, canonicals and hreflang are unchanged by
...
export default async function KSafetyPage({
  ...
  const { locale } = await params
  return <SolutionRoute p={KSAFETY} locale={locale} />
}
