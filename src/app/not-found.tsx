  ...
  return (
    ...
    <div style={{ background: '#0f1724', color: '#e6eef8', fontFamily: 'sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', margin: 0 }}>
      <div style={{ textAlign: 'center' }}>
        ...
        {/* Deliberately a plain <a>. This 404 serves routes *outside* the
            [locale] segment, so "/" still has to pass through the locale
            middleware to be rewritten to /en or /es. A soft client navigation
            bypasses that server-side step; a full load gets the visitor to a
            correctly localised homepage. */}
