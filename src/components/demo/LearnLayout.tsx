  ...
  if (isLightBg) {
    return (
      ...
      <div className="learn-outer" style={{
        ...
        <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, paddingTop: 10 }}>
          {prevStage && onPrev && (
            <button
              onClick={onPrev}
              style={{
                ...
                border: '1.5px solid rgba(15,35,80,0.15)',
                color: 'rgba(15,35,80,0.45)',
                cursor: 'pointer', transition: 'all 0.2s',
                fontFamily: 'var(--font-manrope), Manrope, sans-serif',
                fontSize: '0.8rem', fontWeight: 800,
                letterSpacing: '-0.01em', textTransform: 'uppercase',
              }}
              onMouseEnter={(e) => { e.currentTarget.style.color = '#0b1c36'; e.currentTarget.style.borderColor = 'rgba(15,35,80,0.3)' }}
              onMouseLeave={(e) => { e.currentTarget.style.color = 'rgba(15,35,80,0.45)'; e.currentTarget.style.borderColor = 'rgba(15,35,80,0.15)' }}
            >
              ← {prevStage.label}
            </button>
          )}
          <a
            ...
            style={{
              ...
              background: '#0b1a30', border: '1.5px solid #0b1a30',
            ...
            onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = '#14274a' }}
            onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = '#0b1a30' }}
          >
