  ...
  return (
    ...
    <style>{`
      ...
      @media (max-width: 1280px) {
        ...
        .pp-center-panel { flex: none !important; min-height: 460px; height: auto !important; border-right: none !important; border-bottom: 6px solid rgba(255,255,255,0.6) !important; overflow: hidden !important; }
