  ...
  return (
    ...
    <style>{`
      ...
      @media (max-width: 1100px) {
        .pp-camera-panel { display: none !important; }
        .pp-center-panel { border-right: none !important; }
      }
      @media (max-width: 768px) {
        .pp-main-row { flex-direction: column !important; }
        .pp-left-panel { flex: 0 0 auto !important; max-height: 45%; overflow-y: auto; border-right: none !important; border-bottom: 1px solid rgba(173,198,255,0.1) !important; }
        .pp-center-panel { flex: 1 !important; min-height: 0; border-right: none !important; }
      }
      @media (max-width: 480px) {
        .pp-left-panel { max-height: 35% !important; }
      }
    `}</style>
