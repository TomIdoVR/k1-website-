    ...
    return (
      ...
      <div className="understand-outer" style={{
        ...
        <div style={{ flexShrink: 0, paddingBottom: 12 }}>
          ...
          <h2 style={{ fontSize: 'clamp(1.9rem, 2.6vw, 2.8rem)', fontWeight: 900, fontStyle: 'italic', letterSpacing: '-0.025em', textTransform: 'uppercase', lineHeight: 1.0, color: '#0b1c36', marginBottom: 10 }}>
            {stage.headline}
          </h2>
