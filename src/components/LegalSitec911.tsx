 ...
 * SITEC 911 emergency app. Responsible entity is CityShob Software Ltd.
...
const DEVELOPER = 'CityShob Software Ltd.'
const ADDRESS = 'HaAlon 4 St., Kfar Netter, Israel'
const SUPPORT_EMAIL = 'Support@CityShob.com'
...
const preamble: string[] = [
  'ESTOS TÉRMINOS DE USO («CONDICIONES DE USO» O «TÉRMINOS») CONSTITUYEN UN ACUERDO LEGAL QUE REGULA LA RELACIÓN COMERCIAL ENTRE USTED, UN INDIVIDUO (EL "USUARIO" O "USTED") Y CITYSHOB SOFTWARE LTD. ("CITYSHOB"), CON RESPECTO AL USO DE LA APLICACIÓN SITEC 911 (LA "APLICACIÓN").',
  'AL HACER CLIC EN EL BOTÓN "ACEPTAR" Y/O AL DESCARGAR, INSTALAR O UTILIZAR LA APLICACIÓN EN SU DISPOSITIVO MÓVIL ("DISPOSITIVO"), USTED CONFIRMA QUE HA LEÍDO Y COMPRENDIDO ESTOS TÉRMINOS Y LA POLÍTICA DE PRIVACIDAD DE CITYSHOB (QUE SE INCORPORA POR LA PRESENTE REFERENCIA Y FORMA PARTE DE ESTOS TÉRMINOS), Y EL CONSENTIMIENTO DE ESTAR OBLIGADO POR LOS TÉRMINOS DE USO Y LA POLÍTICA DE PRIVACIDAD. CUALQUIER DESCARGA, INSTALACIÓN O USO DE LA APLICACIÓN, INCLUYENDO CUALQUIER VERSIÓN ACTUALIZADA DE LA APLICACIÓN, ESTÁ SUJETA A, Y PERMANECERÁ SUJETA A LAS CONDICIONES DE ESTOS TÉRMINOS, EN CUALQUIER MOMENTO.',
  'CITYSHOB SE RESERVA EL DERECHO DE HACER CAMBIOS EN LOS TÉRMINOS, A SU ÚNICA Y ABSOLUTA DISCRECIÓN, AL PUBLICAR LOS TÉRMINOS MODIFICADOS. EL USO CONTINUADO DE LA APLICACIÓN POSTERIOR A LA PUBLICACIÓN DE TÉRMINOS ACTUALIZADOS POR CITYSHOB CONSTITUYE LA ACEPTACIÓN DE CUALQUIER VERSIÓN MODIFICADA DE LOS TÉRMINOS.',
]
...
const termsSections: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Sujeto a los términos y condiciones de estos Términos, CityShob le otorga a Usted una licencia limitada, personal, no exclusiva, no asignable, revocable y no sublicenciable para usar una copia de la Aplicación en un Dispositivo que usted posee o controla, sólo para uso personal, todo de acuerdo con los términos y sujeto a las condiciones contenidas en estos Términos (la «Licencia»). CityShob se reserva todos los demás derechos sobre la Aplicación que no se otorgaron explícitamente en virtud de estos Términos. La Licencia está condicionada al total cumplimiento de las condiciones de estos Términos y será rescindida inmediatamente si usted incumple cualquiera de los términos del presente.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Deberá informar a CityShob, de inmediato, sobre cualquier posibilidad de daño que pueda ocasionarse a otros usuarios y/o terceros y/o CityShob y/o de un incumplimiento existente o anticipado de la ley aplicable, debido y/o como consecuencia del uso de la Aplicación.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      'Cualquier Contenido de usuario cargado por Usted será bajo Su única y exclusiva responsabilidad y CityShob no será responsable de ninguna manera por dicho Contenido de usuario.',
      'Usted será totalmente responsable por el Contenido de usuario cargado y/o compartido por Usted, incluyendo sin limitaciones por acto de difamación y/o violación de la privacidad y/o violación de derechos de propiedad y/o contractual y/o violación de un decreto judicial y/o cualquier otra violación, y usted exime expresamente a CityShob, incluidos sus representantes, empleados, gerentes y accionistas que actúan en su nombre («Representantes»), de toda responsabilidad en relación con ello.',
      'Por la presente, usted se compromete a indemnizar a CityShob y/o sus Representantes, inmediatamente después de su primera solicitud, por cualquier daño, lesión, pérdida, gasto, tarifa, lucro cesante, pérdida de datos, pérdida de uso y daño a la buena voluntad, en que puedan incurrir por cualquier reclamo y/o demanda de un tercero (incluidas las Autoridades), incluidos los honorarios legales, debido a la violación por su parte de estos Términos, en relación con Sus actividades a través de la Aplicación. La indemnización antes mencionada no derogará ningún recurso al que CityShob tenga derecho por cualquier ley aplicable.',
      'Usted reconoce y acepta que debe evaluar el riesgo de enviar Contenido de usuario antes de que se cargue y asumir todos los riesgos con respecto a la carga de dicho Contenido de usuario, y que en ningún caso CityShob será responsable de los costos o gastos de daños causados a un tercero por la carga de Contenido de usuario de dicho tercero; y por la presente usted exime a CityShob, total y completamente, incluidos sus Representantes, de cualquier responsabilidad por los costos o gastos de daños que se acumulen o puedan ser causados a cualquier tercero en relación con la publicación del Contenido de usuario.',
      'CityShob puede, a su entera discreción, negarse a permitirle compartir Contenido de usuario con cualquier autoridad sin la necesidad de recibir Su consentimiento o proporcionarle un aviso previo, en caso de que CityShob sospeche de una violación y/o riesgo de violación de las disposiciones de estos Términos, las disposiciones de la ley aplicable o los derechos de terceros y/o en caso de una solicitud de una autoridad competente y/o como resultado de razones técnicas, incluidos los cambios tecnológicos, o debido a la solicitud de la parte receptora, incluso si las copias de seguridad del Contenido del usuario no se guardan ni almacenan. CityShob también puede notificarle que no hay necesidad de dicho Contenido de usuario y, por lo tanto, no se cargará dicho Contenido de usuario.',
      'Usted reconoce que CityShob y/o las autoridades pueden usar el Contenido del usuario, a su entera y absoluta discreción, para cualquier propósito, y por la presente le otorga a CityShob y sus sucesores una licencia mundial, no exclusiva, perpetua, irrevocable, libre de regalías, sublicenciable y transferible para usar, copiar, reproducir, alterar, modificar, crear trabajos derivados de, distribuir, publicar, mostrar, ejecutar, transmitir, difundir o explotar de otra manera su Contenido de usuario sin limitación y sin el derecho a recibir ninguna compensación.',
  ...
  },
  {
    ...
    paragraphs: [
      'Usted reconoce y confirma que la Aplicación y cualquier material relacionado con la misma, incluidos, entre otros, material, diseños de texto, software, música, video, gráficos y materiales contenidos en anuncios o mensajes que se le envíen o información comercial que le ofrezca CityShob, o que fueron creados o desarrollados por CityShob, son propiedad exclusiva de CityShob y/o están debidamente autorizados por terceros y permanecerán en la propiedad exclusiva de CityShob en todo momento. Todos los derechos de propiedad intelectual que existen y/o están incorporados en la Aplicación, y/o adjuntos, vinculados y/o que hacen referencia a la Aplicación, son propiedad exclusiva de CityShob y seguirán siendo propiedad exclusiva de CityShob como se indica.',
      'Estos Términos no le otorgan ningún derecho en la Aplicación y/o con respecto a ella, y/o en cualquier material que se le transfiera y/o en cualquier contenido, incluido el Contenido del usuario, sino solo un derecho limitado a ver los materiales proporcionados a Usted de acuerdo con estos Términos y las disposiciones de la ley aplicable. Nada de lo establecido en estos Términos constituye una renuncia a los derechos de propiedad intelectual de CityShob o de cualquier tercero bajo cualquier ley.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'ADEMÁS, RECONOCE Y ACEPTA QUE BAJO NINGUNA CIRCUNSTANCIA CITYSHOB, SUS FUNCIONARIOS, DIRECTORES, EMPLEADOS O AGENTES SERÁN RESPONSABLES ANTE USTED O CUALQUIER OTRA PERSONA O ENTIDAD POR CUALQUIER DAÑO DIRECTO, INDIRECTO, INCIDENTAL, ESPECIAL, DAÑOS POR PÉRDIDA DE BENEFICIOS, BUENA VOLUNTAD, USO, DATOS, INTERRUPCIÓN DEL SERVICIO, DAÑO DE LA COMPUTADORA O FALLA DEL SISTEMA O EL COSTO DE LOS PRODUCTOS O SERVICIOS SUSTITUTOS (INCLUSO SI CITYSHOB HA SIDO ADVERTIDO DE LA POSIBILIDAD DE TALES DAÑOS), RESULTANTES DE O CONEXOS CON ESTOS TÉRMINOS DE USO O POR EL USO O LA INCAPACIDAD PARA UTILIZAR LA APLICACIÓN O LOS SERVICIOS, YA SEA BASADO EN GARANTÍA, CONTRATO, AGRAVIO (INCLUYENDO NEGLIGENCIA) O DE OTRO MODO, Y SI UN RECURSO LIMITADO ESTABLECIDO EN ESTE DOCUMENTO NO HA CUMPLIDO SU PROPÓSITO ESENCIAL.',
  ...
  },
  {
    ...
    terms: [
      ...
      { term: 'No cesión', def: 'Usted no puede ceder estos Términos sin el consentimiento previo por escrito de CityShob. CityShob puede ceder este Acuerdo sin su consentimiento.' },
